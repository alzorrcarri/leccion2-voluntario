...
/* EJERCICIO VOLUNTARIO 2 PRIMER APARTADO DE LA LECCIÓN 2 DE FÍSICA COMPTACIONAL */
...
int main (void)
{
    ...
    int i,j,k,l,m,aleatorio;
    double a,h,p,temp,aux,pasos,deformacion,solapamiento;
    int matriz[100][82];
    int patron[100][82];
